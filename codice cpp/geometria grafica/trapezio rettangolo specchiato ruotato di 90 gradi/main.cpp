...
il carattere "*" un trapezio rettangolo ruotato di 90 gradi come in figura di base maggiore pari al maggiore 
...
{   
    ...
    int check; //verifica quando smettere di stampare un rettangolo e quando cominciare a stampare un triangolo
    ...
    check = x - y + 1; //imposta il numero di punti da stampare per ogni riga 
    l = 1; //numero si spazi da quando comincia il triangolo
    
    for(i = 0; i < x; i++){ //ciclo che scorre le righe 
        
        cout << endl;
        
        if(i < check){ //prima parte in cui si stampa un semplice rettangolo
            for(j = 0; j < y; j++){ 
            cout << "* "; 
            }
        }
            ...
            for(j = 0; j < l; j++){ //stampo i punti stampandone per ogni riga sempre uno in meno 
                cout << "  "; 
            }
            ...
            l++; //aggiorno il numero di punti da stampare 
        }
