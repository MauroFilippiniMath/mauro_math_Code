...
scrivi un programma che dati in input 2 numeri interi x e y stampi a viedeo mediante
il carattere "*" un trapezio rettangolo ruota di 180 gradi come in figura di base maggiore pari al maggiore 
...
{   
    ...
    l = x; //numero di punti per la prima riga 
