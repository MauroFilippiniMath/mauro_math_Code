...
il carattere "*" un trapezio rettangolo ruotato di 270 gradi come in figura di base maggiore pari al maggiore 
...
{   
    ...
    int check; //indica quando cominciare a stampare a video un triangolo
