...
Individua il numero più grande che si può realizzare in seguito allo spostamento 
...
{   
    ...
    cout << "Il numero più grande ottenibile dalle cifre del numero inserito è: "
    << a * 1000 + b * 100 + c * 10 + d; 
